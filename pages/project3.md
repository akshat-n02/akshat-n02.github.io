...
<p>Supported the planning and preparation for both small- and large-scale events, contributing across all stages from concept to execution.</p>

<h2>Space Creation & Setup</h2>
<p>Was responsible for transforming the venue into an environment that felt open and welcoming for conversation rather than formal networking — shaping the atmosphere through layout, lighting, and spatial arrangement.</p>

<h2>Operational Support</h2>
<p>Handled the full guest experience: welcoming and orienting attendees, managing orders, and anticipating event needs throughout the evening to ensure everything ran smoothly.</p>
